...
/**
 * Implements the Stoer and Wagner minimum cut algorithm.  Deterministically computes the
 * minimum cut in O(|V||E|  + |V|log|V|) time.  This implementation uses Java's PriorityQueue
 * and requires O(|V||E|log|E|) time. 
 * 
